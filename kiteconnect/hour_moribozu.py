...
def list_to_monitor():
    ...
    for symbol in NIFTYFNO:
        candle = kite.historical_data(symbol_to_token[symbol], "2022-07-28 00:00:00", "2022-07-28 15:30:00", "hour", continuous=False, oi=False)
        sma_list=[]
        print(count)
        count = count+1
        for i in candle[:5]:
