...
def get_20ma(candle):
    ma20=sum(item['close'] for item in candle[-21:])/20
...
def main_function():
    ...
    from_date = "2021-12-3 00:00:00"
    to_date = "2021-12-3 23:59:59"
    ...
    for token in token_list:
        ...
        ma20=get_20ma(hist_candles_yesterday)
        ...
        if t["low"]<ma20 and t["close"]>ma20 and t["open"] < ma20+(ma20/20) and t["volume"]>10000:
            print(token_to_symbol[token])
    ...
    print(last_list)
    '''
    res = dict(sorted(ma_dict.items(), key = itemgetter(1))[:10])
    print("The minimum 10 value pairs are " + str(res))
