...
def save_to_file():
    ...
    if os.path.exists("ma20_stocks.txt"):
        with open("ma20_stocks.txt", 'r+') as file:
            ...
            print(str_to_write)
            with open("ma20_stocks.txt", 'w') as file:
                file.truncate(0)
    ...
    if os.path.exists("ma20_stocks.txt"):
        with open("ma20_stocks.txt", 'r+') as file:
            ...
            for symbol in watchlist:
                ...
                print(sma20)
                if l<=sma20<=h:
                    os.system('spd-say "stock between twenty M A "')
                    print(symbol)
