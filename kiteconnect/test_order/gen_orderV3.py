...
#python3 gen_orderV3.py hdfcamc g 1
...
call_symbol,put_symbol,call_strike,put_strike=get_call_put_option(sys.argv[1].upper(),"23-Feb-2023","FEB","23")
...
candle = kite.historical_data(symbol_to_token[symbol], from_date, date+" 15:35:00", "5minute", continuous=False, oi=False)
...
symbol="NSE:"+sys.argv[1].upper()
if sys.argv[2]=="g":
    fno_symbol="NFO:"+sys.argv[1].upper() + "23FEB"+call_strike+"CE"
if sys.argv[2]=="l":
    fno_symbol="NFO:"+sys.argv[1].upper() + "23FEB"+put_strike+"PE"
...
print(kite.ltp(fno_symbol)[fno_symbol]["last_price"] * lot_size[symbol.replace("NSE:","")])
#print(kite.ltp(fno_symbol) * lot_size[symbol.replace("NSE:","")])

if sys.argv[2]=="g":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "23FEB"+call_strike+"CE"+"\"" +",ltp_dict" + ","+sys.argv[3] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "23FEB"+call_strike+"CE"+"\"" +",ltp_dict" + ")"

if sys.argv[2]=="l":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "23FEB"+put_strike+"PE"+"\"" +",ltp_dict" +","+sys.argv[3] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "23FEB"+put_strike+"PE"+"\"" +",ltp_dict" + ")"
print(s)
print("")
print("")
...
with open("readorder.txt", "w") as text_file:
    text_file.write("    "+s+"\n")
    print("")
#with open(fno_symbol.replace("NFO:",""), "w") as text_file:
#    text_file.write("    "+sl+"\n")
