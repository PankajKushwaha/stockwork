...
#order("NFO:g:"+"RBALBANK","g",302.1,"b","RBALBANK22SEP130CE",ltp_dict)
#gen_order.py rblbank g 302.1 b 130 ce

print("python3 gen_order.py  rblbank g 300 b 310 ce")

symbol="NFO:g:"+sys.argv[1].upper()
fno_symbol="NFO:"+sys.argv[1].upper() + "23JAN"+sys.argv[5]+sys.argv[6].upper()
...
s = "order(\"NFO:g:"+sys.argv[1].upper()+"\""+ ",\"" + sys.argv[2] + "\"" + "," + sys.argv[3] + ","+ "\"" + sys.argv[4] +"\"" +"," + "\"" + sys.argv[1].upper() + "23JAN"+sys.argv[5]+sys.argv[6].upper()+"\"" +",ltp_dict," +sys.argv[7]+ ")"
