...
symbol="NSE:"+sys.argv[1].upper()
if sys.argv[2]=="g":
    fno_symbol="NFO:"+sys.argv[1].upper() + "22NOV"+sys.argv[3]+"CE"
if sys.argv[2]=="l":
    fno_symbol="NFO:"+sys.argv[1].upper() + "22NOV"+sys.argv[3]+"PE"
...
if sys.argv[2]=="g":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "22NOV"+sys.argv[3]+"CE"+"\"" +",ltp_dict" + ","+sys.argv[4] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "22NOV"+sys.argv[3]+"CE"+"\"" +",ltp_dict" + ")"

if sys.argv[2]=="l":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "22NOV"+sys.argv[3]+"PE"+"\"" +",ltp_dict" +","+sys.argv[4] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "22NOV"+sys.argv[3]+"PE"+"\"" +",ltp_dict" + ")"
print(s)
print("")
print("")
