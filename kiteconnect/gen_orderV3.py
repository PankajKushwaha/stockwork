...
call_symbol,put_symbol,call_strike,put_strike=get_call_put_option(sys.argv[1].upper(),"29-Mar-2023","MAR","23")
...
symbol="NSE:"+sys.argv[1].upper()
if sys.argv[2]=="g":
    fno_symbol="NFO:"+sys.argv[1].upper() + "23MAR"+call_strike+"CE"
if sys.argv[2]=="l":
    fno_symbol="NFO:"+sys.argv[1].upper() + "23MAR"+put_strike+"PE"
...
if sys.argv[2]=="g":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "23MAR"+call_strike+"CE"+"\"" +",ltp_dict" + ","+sys.argv[3] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "23MAR"+call_strike+"CE"+"\"" +",ltp_dict" + ")"

if sys.argv[2]=="l":
    s = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"l"+"\""+","+ str(low) +  ",\"" + "b" +"\""+"," + "\"" + sys.argv[1].upper() + "23MAR"+put_strike+"PE"+"\"" +",ltp_dict" +","+sys.argv[3] + ")"
    sl = "order(\"NSE:"+sys.argv[1].upper()+"\""+ ",\"" +"g"+"\""+","+ str(high) +  ",\"" + "s" +"\""+"," + "\"" + sys.argv[1].upper() + "23MAR"+put_strike+"PE"+"\"" +",ltp_dict" + ")"
print(s)
print("")
print("")
