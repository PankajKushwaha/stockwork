...
dir_path="/home/pankaj/Pictures/trend/"
...
for stock in NIFTY500:
    ...
    p2 = p2.tail(3)
    plow = p2["Low"].tolist()
    phigh = p2["High"].tolist()
    if (plow[0] < plow[1] < plow[2] and phigh[0] < phigh[1] < phigh[2]) or (plow[0] > plow[1] > plow[2] and phigh[0] > phigh[1] > phigh[2]):
