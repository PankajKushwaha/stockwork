...
dir_path="/home/pankaj/Pictures/ma20/"
...
for stock in NIFTY500:
    ...
    data = pd.read_sql('select * from '+stock ,  conn)
    ...
    if (ma20+((ma20/100)*margin) > ltp and ma20-((ma20/100)*margin) < ltp) or \
        (ma40+((ma40/100)*margin) > ltp and ma40-((ma40/100)*margin) < ltp) or \
        (ma200+((ma200/100)*margin) > ltp and ma200-((ma200/100)*margin) < ltp):
